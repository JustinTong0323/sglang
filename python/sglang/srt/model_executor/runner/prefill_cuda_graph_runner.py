                ...
                if pp_proxy_tensors is not None:
                    ...
                    for embeds_name in ("input_embeds", "inputs_embeds"):
                        if embeds_name in kwargs:
                            ...
                            break
                elif self.buffer_registry.has_slot("input_deepstack_embeds"):
                    kwargs["input_deepstack_embeds"] = self.buffer_registry.get_slot(
    ...
    def _execute_body_capture(
        ...
        **kwargs,
        ...
        def replay_layer_forward(*args, **layer_kwargs):
            ...
            elif layer_kwargs.get("input_deepstack_embeds") is not None:
                raise RuntimeError(
                    "model passed input_deepstack_embeds but no BCG replay slot "
                    "was allocated; check supports_bcg_deepstack_replay/"
